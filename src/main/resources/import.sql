...
insert into restaurante (id, nome, taxa_frete, cozinha_id) values (4, 'EAI Burguer', 25, 3);
insert into restaurante (id, nome, taxa_frete, cozinha_id) values (5, 'Spoler Burguer', 155, 3);
