...
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao) values (4, 'EAI Burguer', 25, 3, current_timestamp, current_timestamp);
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao) values (5, 'Spoiler Burguer', 155, 3, current_timestamp, current_timestamp);
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao) values (6, 'Java Steakhouse', 12, 3, current_timestamp, current_timestamp);
