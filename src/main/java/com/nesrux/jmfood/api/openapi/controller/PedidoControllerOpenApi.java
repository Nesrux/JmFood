...
public interface PedidoControllerOpenApi {
	...
	public PedidoModel buscar(@ApiParam(value = "Codigo de um pedido", example = "d178b637-a785-4768-a3cb-aa1ce5a8cdab", required = true) String codigoPedido);
	
	@ApiOperation("Cadastro de um pedido")
	@ApiResponses({
		@ApiResponse(code = 201,message = "Pedido Criado com sucesso")})
	public PedidoModel adicionar(@ApiParam(name= "corpo", value="Representação de um pedido", required = true) PedidoInputDto pedidoInput);
