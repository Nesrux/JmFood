...
public interface FluxoPedidoControllerOpenApi {
	...
	@ApiResponses({
		...
		@ApiResponse(code =  404, message =  "Não foi possivel confirmar pedido, pois o pedido com esse código nao existe"),
	...
	@ApiResponses({
		@ApiResponse(code = 400, message = "Id de pedido inválido"),
		@ApiResponse(code =  404, message =  "Não foi possivel entregar pedido, pois o pedido com esse código nao existe"),
	...
	@ApiResponses({
		@ApiResponse(code = 400, message = "Id de pedido inválido"),
		@ApiResponse(code =  404, message =  "Não foi possivel cancelar pedido, pois o pedido com esse código nao existe"),
