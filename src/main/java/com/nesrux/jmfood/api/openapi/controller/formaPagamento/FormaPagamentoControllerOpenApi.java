...
public interface FormaPagamentoControllerOpenApi {
	...
	FormaPagamentoModel adicionar(@ApiParam(name = "corpo", value ="Representação de uma forma de pagamento", required = true) FormaPagamentoInputDto inputDto);
	...
	FormaPagamentoModel atualizar(@ApiParam(name = "corpo", value ="Representação de uma forma de pagamento", required = true) FormaPagamentoInputDto inputDto,
