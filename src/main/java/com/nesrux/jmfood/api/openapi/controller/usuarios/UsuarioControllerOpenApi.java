...
public interface UsuarioControllerOpenApi {
	...
	@ApiResponses({
		@ApiResponse(code = 400, message = "Codigo de usuario inválido"),
	...
	@ApiResponses({
		@ApiResponse(code = 400, message = "representação de usuario inválida"),
	...
	@ApiResponses({
		@ApiResponse(code = 400, message = "Codigo de usuario  ou representação de usuario inválido"),
		@ApiResponse(code = 404, message = "Id de usuario não existe"),
	...
	@ApiResponses({
		@ApiResponse(code = 400, message = "Codigo de usuario ou representação de senha inválido"),
		@ApiResponse(code = 404, message = "Id de usuario não existe"),
