...
public interface GrupoPermissaoControllerOpenapi {
	...
	@ApiResponses({
		@ApiResponse(code = 400, message = "Codigo de grupo inválido"),
		@ApiResponse(code = 404, message = "codigo de grupo não existe"),
	...
	@ApiResponses({
		@ApiResponse(code = 400, message = "Codigo de grupo ou de permissão estão inválidos"),
		@ApiResponse(code = 404, message = "Codigo de grupo ou de permissão não existem"),
