package com.nesrux.jmfood.api.openapi.controller.produtos;
...
public interface RestauranteFotoProdutoControllerOpenApi {
	...
	@ApiResponses({
		@ApiResponse(code =  400, message = "Ocorreu um erro na requisição, parametros invalidos ou arquivo invalido"),
		@ApiResponse(code =  404, message = "Não foi possivel atualizar pois o Id de restaurante ou de produto nao existem"),
	...
	@ApiResponses({
		@ApiResponse(code =  400, message = "Ocorreu um erro na requisição, parametros invalidos ou arquivo invalido"),
		@ApiResponse(code =  404, message = "Não foi possivel buscar pois o Id de restaurante ou de produto nao existem"),
	...
	@ApiResponses({
		@ApiResponse(code =  400, message = "Id do restaurante ou do produto inválido"),
		@ApiResponse(code =  404, message = "Não foi possivel excluir pois o Id de restaurante ou de produto nao existem"),
