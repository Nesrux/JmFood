...
public class CadastroProdutoService {
	...
	public Produto acharOuFalhar(Long produtoId) {
		return repository.findById(produtoId).orElseThrow(() -> new ProdutoNaoEncontradoException(produtoId));
	}
	...
	public List<Produto> acharTodosAtivos(Restaurante restaurante) {
	...
	// Listar produtos pelo id de restaurante
